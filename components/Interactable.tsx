...
interface IProps {
  ...
  animatedValueY: Animated.Value<any>;
  animatedValueX: Animated.Value<any>;
}

class Interactable extends Component<IProps> {
  static defaultProps = {
    dragToss: 0.1,
    dragEnabled: true,
  ...
  _dragging: any;
  _velocity: any;
  _position: {x: Animated.Value<any>; y: Animated.Value<any>};
  _snapAnchor: {
    x: Animated.Value<any>;
    y: Animated.Value<any>;
    tension: Animated.Value<300>;
    damping: Animated.Value<0.7>;
  };
